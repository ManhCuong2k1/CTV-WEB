<template>
    ...
    >
        ...
        <el-divider />
        <el-form-item label="Họ và tên người liên hệ" prop="contact.name">
            <el-input v-model="form.contact.name" placeholder="Nhập họ tên người liên hệ" />
        </el-form-item>
        <el-form-item label="Số điện thoại liên hệ" prop="phone">
            <el-input v-model="form.contact.phone" placeholder="Nhập số điện thoại liên hệ" />
        </el-form-item>
        <el-form-item label="Email liên hệ" prop="contact.email">
            <el-input v-model="form.contact.email" placeholder="Nhập email liên hệ" />
        </el-form-item>
